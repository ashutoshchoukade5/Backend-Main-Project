...
public class BusController {
    ...
    @GetMapping(path = BusLinks.GET_STUDENTS_BY_BUS_ID)
    public ResponseEntity<List<StudentDto>> getStudentsByBusId(@PathVariable Long busId) {
        List<StudentDto> students = busService.getStudentsByBusId(busId);
